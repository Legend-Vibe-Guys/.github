...
파편화되어 있는 영유아의 일상 관찰 기록, 사진, 출결 데이터를 하나의 플랫폼으로 통합하며, 구글의 최신 **Gemini-3.1-flash-lite-preview**을 활용하여 단편적인 기록들을 종합적이고 전문적인 '월간 발달 리포트'로 자동 변환합니다.
...
* **스마트 발달 리포트 자동 생성:** 파편화된 일상 관찰 메모(한 달 치)를 `gemini-3.1-flash-lite-preview` 모델이 취합 및 분석합니다.
